...
class Server {
  ...
  public routes(): void {
    ...
    this.app.use('/api/v1/products', productRoutes.router);

    this.app.use('/api/v1/features', featureRoutes.router);

    this.app.use('/api/v1/brands', brandRoutes.router);

    this.app.use('/api/v1/categories', categoryRoutes.router);
