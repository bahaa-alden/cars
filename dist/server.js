...
const order_item_routes_1 = require("./routes/order-item.routes");
const order_routes_1 = require("./routes/order.routes");
const product_routes_1 = require("./routes/product.routes");
const feature_routes_1 = require("./routes/feature.routes");
...
class Server {
    ...
    routes() {
        this.app.use('/api/v1/order-items', order_item_routes_1.orderItemRoutes.router);
        this.app.use('/api/v1/orders', order_routes_1.orderRoutes.router);
        this.app.use('/api/v1/products', product_routes_1.productRoutes.router);
        this.app.use('/api/v1/features', feature_routes_1.featureRoutes.router);
        this.app.use('/api/v1/brands', brand_routes_1.brandRoutes.router);
        this.app.use('/api/v1/categories', category_routes_1.categoryRoutes.router);
